...
<br><br>
<div class="container">
    <form action="AtributoEditarPHP.php" method="post" enctype="multipart/form-data">
        <p class="h4"> Editar Atributo</p><br><br>
        <div class="form-row">
            <div class="form-group col-sm-6 col-md-4">
                <label for="usuario" style="font-size:20px;color: rgba(144, 12, 52);"> Nombre actual: </label>
                <select id="nombre" class="form-control" name="nombre_ant" required>
            ...
            <div class="form-group col-sm-6 col-md-4">
                <label for="usuario" style="font-size:20px;color: rgba(144, 12, 52);"> Nombre deseado: </label>
                <input type="text" class="form-control" id="usuario" name="nombre_des" required>
            </div>
